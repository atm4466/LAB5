...
public abstract class IMDB {
     ...
     * lower and upper inclusively.  The movies returned should be ordered by descending runtime length,
     ...
     */
    public abstract Collection<Movie> getMoviesByRuntime(String type, int lower, int upper);
    ...
    public IMDB(boolean small) throws FileNotFoundException {
        ...
        in.close();
        System.out.println("Total movies: " + this.movieList.size());
    }
