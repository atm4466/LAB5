...
public final class Movie implements Comparable<Movie> {
    ...
    public boolean equals(Object other) {
        // TODO Activity 2.1
        Movie alpha = (Movie)other;
        if(this == alpha || (getTitle().equals((alpha).getTitle())) && year == alpha.getYear())
        {
            return true;
        }
        else {
    ...
    public int hashCode() {
        // TODO Activity 2.1
        int value = title.hashCode() + year;
        return value;     // remove when correctly implemented
    }
    ...
    public int compareTo(Movie other) {
        ...
        if(result == 0 ){
            result = year.compare(other.getYear());

        }
        return result;


        // remove when correctly implemented
    }
}
